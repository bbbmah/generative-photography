...
if __name__ == "__main__":
    ...
    # usage example
    # python inference_focal_length.py --config configs/inference_genphoto/adv3_256_384_genphoto_relora_focal_length.yaml --base_scene "example" --focal_length_list "[24.0, 35.0, 50.0, 70.0, 100.0, 150.0, 240.0]"
    # python inference_focal_length.py --config configs/inference_genphoto/adv3_256_384_genphoto_relora_focal_length.yaml --base_scene "example" --focal_length_list "[12.0, 20.0, 30.0, 42.0, 60.0, 80.0, 90.0]"
